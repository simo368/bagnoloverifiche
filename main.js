...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      const data = {
        nome: sanitizeHTML(document.getElementById('contatti-nome').value.trim()),
        email: sanitizeHTML(document.getElementById('contatti-email').value.trim()),
        oggetto: sanitizeHTML(document.getElementById('contatti-oggetto').value),
        messaggio: sanitizeHTML(document.getElementById('contatti-messaggio').value.trim()),
